...
@property (nonatomic, strong) IBOutlet UILabel * _Nullable headlineView;
@property (nonatomic, strong) IBOutlet UIButton * _Nullable callToActionView;
@property (nonatomic, strong) IBOutlet UIImageView * _Nullable iconView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable bodyView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable priceView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable advertiserView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable storeView;
@property (nonatomic, strong) IBOutlet UIView * _Nullable mediaView;
@property (nonatomic, strong) IBOutlet UIView * _Nullable starRatingView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable reviewCountView;
@property (nonatomic, strong) IBOutlet UILabel * _Nullable adLabelView;
@property (nonatomic, strong) IBOutlet UIView * _Nullable adChoicesView;
...
@property (nonatomic, readonly, strong) UIView * _Nullable mediaContent;
